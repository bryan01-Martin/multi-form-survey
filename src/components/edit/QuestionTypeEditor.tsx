...
import LongText from "../../assets/icons/subject.svg?react";
...
function QuestionTypeEditor({ type, onChange }: Props) {
  return (
    <Dropdown<QuestionType>
      ...
      options={[
        ...
        },
        {
          label: (
            <div>
              <LongText className="inline-block mr-10" />
              <span>장문형</span>
            </div>
          ),
          value: "longText",
...
export default observer(QuestionTypeEditor);
